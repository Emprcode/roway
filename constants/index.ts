...
export const NAV_LINKS = [
  ...
  { href: "/", key: "how_roway_work", label: "How Roway Work?" },
...
export const FEATURES = [
  ...
  },
  {
    ...
    variant: "green",
    description:
      "Schedule an adventure with friends. On holidays, there are many interesting offers from Roway. That way, there's no more discussion",
  },
  {
...
export const FOOTER_LINKS = [
  {
    title: "Learn More",
    links: ["About Roway", "Press Releases", "Environment", "Jobs", "Privacy Policy", "Contact Us"],
  },
  {
    title: "Our Community",
    links: ["Climbing club", "Hiking club", "International travel"],
  },
];
...
export const FOOTER_CONTACT_INFO = {
  title: "Contact Us",
  links: [
    { label: "Office", value: "Sydney, Australia" },
    { label: "Email", value: "info@roway.com.au" },
